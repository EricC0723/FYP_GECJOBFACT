...
<div class="site-wrap">
    ...
    <?php 
          ...
          $result = mysqli_query($connect, "SELECT job_post.*, companies.CompanyName FROM job_post
      ...
      <div class="container">
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-4">
            <div class="row">
              <div class="col-6">
                <a href="#" class="btn btn-block btn-light btn-md"><i class="icon-copy fa fa-heart" aria-hidden="true" style="margin-right:10px;color:red;"></i>Unsave</a>
                <a href="#" class="btn btn-block btn-light btn-md"><span class="icon-heart-o mr-2 text-danger"></span></i>Save</a>
                <!-- <span class="icon-heart-o mr-2 text-danger"> -->
              </div>
              <div class="col-6">
                <a href="#" class="btn btn-block btn-primary btn-md">Quick apply</a>
              </div>
            </div>
          </div>
        </div>
