 ...
 <li class="dropdown">
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<?php 
				...
				if(isset($_GET['edit']))
				{
					...
					$result = mysqli_query($connect,"SELECT * FROM companies WHERE CompanyID = '$Companyid'");
        ...
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">Edogaru</span><span class="text-black-50"><?php echo $row['CompanyEmail']; ?></span><span> </span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Company ID :</label><input type="text" class="form-control" placeholder="first name" value="<?php echo $row['CompanyID']; ?>"></div>
                    <div class="col-md-6"><label class="labels">Company Name :</label><input name="CompanyName" type="text" class="form-control" value="<?php echo $row['CompanyName']; ?>" placeholder="surname"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text" class="form-control" name="CompanyPhone" value="<?php echo $row['CompanyPhone']; ?>"></div>
                    <div class="col-md-12"><label class="labels">Contact Person</label><input type="text" class="form-control" value="<?php echo $row['ContactPerson']; ?>"></div>
                    <div class="col-md-12"><label class="labels">Company Size</label><input type="text" class="form-control" value="<?php echo $row['CompanySize']; ?>"></div>
                    <div class="col-md-12"><label class="labels">Company Benefits</label><input type="text" class="form-control" value="<?php echo $row['CompanyBenefits']; ?>"></div>
                    <div class="col-md-12">
					<label class="labels">Company Status :</label>
					<select class="custom-select2 form-control" name="CompanyStatus" style="width: 100%; height: 38px;" value="<?php echo $row['CompanyStatus']; ?>">
...
if (isset($_POST["submitbtn"]))
{
	...
	$sql = mysqli_query($connect,"UPDATE companies SET CompanyName='$name', CompanyPhone='$phone', CompanyStatus='$status' WHERE CompanyID = '$Companyid'");
	echo "Hello, your name is:".$name;
    echo "<br>Your phone number is: ".$phone;
	echo "Company Status is: ".$status;
}
?>
