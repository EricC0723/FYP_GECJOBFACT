...
<body>
				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="company.html"><i class="icon-copy fa fa-address-card" aria-hidden="true"></i><span class="mtext">Company</span></a><li>
						</ul>
					</li>
					<li>
 ...
 <li class="dropdown">
					...
					<li>
						<a href="company.html" class="dropdown-toggle no-arrow">
						<i class="icon-copy fa fa-address-card" aria-hidden="true"></i><span class="mtext">Company</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<table class="data-table table nowrap">
							<thead>
								<tr>
									...
									<th class="table-badge">More Details</th>
									<th class="table-primary">More Details</th>
									<th class="table-secondary">More Details</th>
								</tr>
							</thead>
							<tbody>
								<?php
									...
									if(mysqli_num_rows($result) > 0)
									{
										while ($row = mysqli_fetch_assoc($result))
										{
											...
											<tr>
												...
												<td class="table-plus"><span class="badge badge-pill table-badge"><?php echo $row["CompanyID"]; ?></span></td>
												<td class="table-plus"><?php echo $row["CompanyEmail"]; ?></td>
