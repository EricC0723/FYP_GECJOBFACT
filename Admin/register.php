...
<head>
	...
	<link rel="stylesheet" type="text/css" href="vendors/styles/registercompany.css">
...
<body class="login-page">
				...
				<div class="col-md-6 col-lg-5">
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<form class="tab-wizard2 wizard-circle wizard" method="post" id="form">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="email" class="form-control" id="emailLoginID" name="Email_id">
												<small>error</small>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" name="phone_number" id="MobilePhoneNumber">
												<small>error</small>
											</div>
										</div>
										<div class="form-group row">
										...
										<!-- <div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<div class="custom-control custom-radio custom-control-inline pb-0">
													...
													<label class="custom-control-label" for="male" reqiured>Male</label>
												</div>
												<div class="custom-control custom-radio custom-control-inline pb-0">
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					...
					After verify your company then you can login, we will process you request in a hour
				</div>
	...
	function setErrorFor(input,message){
		...
		formControl.className = 'col-sm-8 error';
	}
	function setSuccessFor(input){
		const formControl = input.parentElement;
		const small = formControl.querySelector('small');
		small.innerText="";
		formControl.className = 'col-sm-8 success';
	}
	</script>
</body>
