...
<body>
					...
					<div class="pb-20">
						...
						<table id="user_table"class="data-table table stripe hover nowrap">
							...
							<?php
									...
									$query = "SELECT * FROM companies WHERE CompanyStatus IN ('Active', 'Blocked','Verify')";
    ...
    <div class="col-md-4 col-sm-12 mb-30">
        ...
        <!-- Edit modal -->
        <div class="col-md-4 col-sm-12 mb-30">
            <div class="modal fade bs-example-modal-lg" id="edit-company-modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="">Edit company data</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                        <div class="row" style="position:center;">
	...
	<script>
        ...
        var data = {
			...
			company_id: $("#edit_companyid").val(),
            company_name: $("#edit_CompanyName").val(),
            contact_person: $("#edit_ContactPerson").val(),
