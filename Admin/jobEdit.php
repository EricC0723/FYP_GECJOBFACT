	...
	<div class="main-container">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Job ID :</label><input type="text" class="form-control" placeholder="first name" value="<?php echo $row['Job_Post_ID']; ?>"></div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-md-12">
					<label class="labels">Job Status :</label>
					<select class="custom-select2 form-control" name="job_status" style="width: 100%; height: 38px;" value="<?php echo $row['job_status']; ?>">
