				...
				<div class="card-box mb-30">
					...
					<div class="pb-20">
						...
						<table id="user_table"class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Career ID</th>
									<th>User ID</th>
									<th>Job Title</th>
									<th>Company</th>
							...
							<?php
									...
									if(mysqli_num_rows($result) > 0)
									{
										while($row = mysqli_fetch_assoc($result))
										{
											?>
											<tr>
												<td class="table-plus"><?php echo $row["CareerID"]; ?></td>
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
															<a class="viewUserBtn dropdown-item" href="#" data-userid="<?=$row['CareerID'];?>"><i class="dw dw-eye"></i> View</a>
															<a class="editUserBtn dropdown-item" href="#" data-userid="<?=$row['CareerID'];?>"><i class="dw dw-edit2"></i> Edit</a>
														</div>
													</div>
												</td>
											</tr>
