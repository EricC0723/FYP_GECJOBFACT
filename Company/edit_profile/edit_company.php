...
<div>
        ...
        <div style="width:600px;">
            ...
            <div>
                <span class="landing_sentence2">
                    <?php echo isset($_SESSION['companyData']['CompanyName']) ? $_SESSION['companyData']['CompanyName'] : 'Company Name'; ?>
                </span>
            </div>
        </div>
    ...
    <div style="padding-top:20px;display:flex;flex-direction:row;align-items:flex-end;">
        <div style="width:600px;">
            ...
            <div>
                <span class="landing_sentence2">
                    <?php echo isset($_SESSION['companyData']['RegistrationNo']) ? $_SESSION['companyData']['RegistrationNo'] : 'Registration No.'; ?>
                </span>
            </div>
        </div>
    </div>
    <div style="padding-top:20px;display:flex;flex-direction:row;align-items:flex-end;">
        <div style="width:600px;">
            ...
            <div>
                <span class="landing_sentence2">
                    <?php
                    if (isset($_SESSION['companyData']['RegistrationDate'])) {
                        $timestamp = strtotime($_SESSION['companyData']['RegistrationDate']);
    ...
    <div style="padding-top:20px;display:flex;flex-direction:row;align-items:flex-end;">
        <div style="width:600px;">
            ...
            <div>
                <span class="landing_sentence2">
                    <?php
                    if (isset($_SESSION['companyData']['CompanySize'])) {
                        echo $_SESSION['companyData']['CompanySize'] == '5000+' ? 'More than 5000 Employees' : $_SESSION['companyData']['CompanySize'] . ' Employees';
                    } else {
                        echo 'CompanySize';
                    }
                    ?>
