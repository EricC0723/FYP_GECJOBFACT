...
if (isset($_GET['jobPostID'])) {
    ...
    $result = mysqli_query($connect, "SELECT * FROM job_post_questions WHERE JobID = '$postid' ");
    $selected_questions = array();
    while ($row = mysqli_fetch_assoc($result)) {
        $selected_questions[] = $row['QuestionID'];
    }
...
if (isset($_POST['submitbtn'])) {
    // Delete all the existing selected questions for the job post
    $delete_sql = "DELETE FROM job_post_questions WHERE JobID = '$job_post_ID'";
...
<body class="postjob_body">
                        ...
                        <div style="padding:0 32px;display:flex;">
                            ...
                            <div style="position:relative;">
                                ...
                                <div class="page_title"><span class="landing_sentence2"
                                        style="font-weight:600">Question</span>
                                </div>
                            </div>
    ...
    <div class="form-container" style="padding-top:32px">
        ...
        <form method="POST">
            ...
            <div class="form-style" style="margin-top:22px;">
                ...
                'Helvetica Neue', HelveticaNeue, Helvetica, Arial, sans-serif;">0/8
                ...
                28px;font-family: Roboto, 'Helvetica Neue', 'HelveticaNeue', Helvetica, Arial, sans-serif;">Recommended
                        questions</span>
    ...
    <script>
        ...
        function updateCheckboxes() {
            ...
            $('div[style="padding-top:20px"] span').text(totalChecked + '/8 questions selected');
