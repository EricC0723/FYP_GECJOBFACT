        ...
        <div style="background:white;width:100%">
                <div style="display:flex;flex-direction:row;justify-content:space-between">
                    ...
                    <?php if ($row['Status'] == 'Accepted' || $row['Status'] == 'Rejected'): ?>
                        <span class="landing_sentence1" style="font-size:18px;">You have already <?php echo strtolower($row['Status']); ?> this application.</span>
                    <?php else: ?>
                        <button class="cont-button" onclick="changeAcceptstatus(<?php echo $applicantId; ?>)">Accept</button>
                        <button class="save-button" style="margin-left:5px;border:1px solid rgb(73, 100, 233)" onclick="changeRejectstatus(<?php echo $applicantId; ?>)">Reject</button>
                    <?php endif; ?>
