...
<div id="addcreditcard">
    <div style="width: 50px;position: relative;top: 25px;left: 25px;"><button id="close-creditcard"
        ...
        <div class="wrapper" id="app">
            <div class="card-form">
                ...
                <div class="card-form__inner">
                    ...
                    <div style="padding-top:10px;"><input type="submit" value="Add Card" class="cont-button"
                            name="submitbtn" style="width:100%;"></div>
...
<script>
    var closeaddbutton = document.getElementById('close-creditcard');
