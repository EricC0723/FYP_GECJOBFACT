...
<body class="postjob_body">
    ...
    <?php
    // If the total number of jobs is more than 2, hide the landing banner
    if ($totalJobs <= 3) {
        ?>

        <div id="landing_banner"
            style="width:100%;height:110px;background:white;box-shadow:rgba(28, 35, 48, 0.1) 0px 2px 4px 0px, rgba(28, 35, 48, 0.1) 0px 2px 2px -2px, rgba(28, 35, 48, 0.2) 0px 4px 4px -4px;border-bottom: 1px solid #d2d7df;">
            <div class="container">
                <div style="width: 1184px;margin: auto;padding: 0 48px;height: 100%;">
                    <div style="padding:24px;display: flex; justify-content: space-between;">
                        <?php
                        // If the total number of jobs is more than 2, hide the landing banner
                        if ($totalJobs == 0) {
                            ?>
                            ...
                            $recentJob = mysqli_fetch_assoc($result);
                            $jobStatus = htmlspecialchars($recentJob['job_status']);
                            ...
                            <div style="width:830px;">
                                ...
                                <div style="padding-top:10px;"><span class="landing_sentence2">You're in the right place to find
                                        ...
                                        <span style="font-weight:700;">
                                            <?php echo $recentJob['Job_Post_Title']; ?>
                                        </span> in
                                        <span style="font-weight:700;">
                                            <?php echo $recentJob['Job_Post_Location']; ?>
                                        </span>.
                                    </span></div>
                            </div>
                            <?php
                            ...
                            switch ($jobStatus) {
                                case 'Draft':
                                    ...
                                    break;
                                case 'Active':
                                    echo '<a href="view-job-classify.php?jobPostID=' . htmlspecialchars($recentJob['Job_Post_ID']) . '" class="create_btn">View post</a>';
                                    break;
                                case 'Closed':
                                    echo '<a href="view-job-classify.php?jobPostID=' . htmlspecialchars($recentJob['Job_Post_ID']) . '" class="create_btn">View post</a>';
                                    break;
        ...
        <div style="margin:0;background:white;width:100%;display:flex;justify-content:center;">
            <div style="padding:32px 48px;max-width:1280px;">
                <div style="padding:32px">
                    <div>

                        <div>
                            <h2 class="landing_sentence3" style="text-align:center;">Find the best person for your role</h2>
                        </div>
                                    ...
                                    <div>
                                        <div>
                                            <div>
                                                ...
                                                <div style="padding-top:10px;"><span class="landing_sentence2">Our
                                                        step-by-step guide makes posting your job ad quick and
                                                        easy.</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div style="width:310px;padding-left:90px;text-align:center;">
                                    <div style="display: flex;justify-content:center;">
                                        <div style="width:120px;">
                                            <svg viewBox="0 0 120 120">
                                                <g fill="none" fill-rule="evenodd">
                                                    ...
                                                    <g>
                                                        <path fill="#031D44" fill-rule="nonzero"
                                                            d="M51.962 68.802c.553 0 1 .448 1 1 0 .513-.386.935-.883.993l-.117.007H17.321c-.553 0-1-.448-1-1 0-.513.386-.936.883-.993l.117-.007h34.641zM16.372 74.435l20.208.281c.552.008.994.462.986 1.014-.007.513-.4.93-.897.98l-.117.006-20.207-.281c-.553-.008-.994-.462-.987-1.014.008-.513.4-.93.898-.98l.116-.006z"
                                                            transform="translate(9 14)"></path>
                                                        <path fill="#031D44" fill-rule="nonzero"
                                                            d="M84.587 57.335H11.04c-3.955 0-7.166 3.172-7.166 7.091v16.125c0 3.918 3.211 7.09 7.166 7.09h73.547c3.955 0 7.166-3.172 7.166-7.09V64.426c0-3.919-3.211-7.09-7.166-7.09zm-73.547 2h73.547c2.856 0 5.166 2.282 5.166 5.091v16.125c0 2.808-2.31 5.09-5.166 5.09H11.04c-2.856 0-5.166-2.282-5.166-5.09V64.426c0-2.809 2.31-5.09 5.166-5.09z"
                                                            transform="translate(9 14)"></path>
                                                        <path fill="#FFCFDD"
                                                            d="M88.109 56.363l-80.51 5.463c-3.366.212-6.267-2.312-6.482-5.637L.013 38.052c-.214-3.325 2.34-6.192 5.706-6.403l80.51-5.464c3.365-.212 6.267 2.312 6.481 5.637l1.106 18.138c.214 3.325-2.341 6.191-5.707 6.403"
                                                            transform="translate(9 14)"></path>
                                                        <path fill="#FFF" fill-rule="nonzero"
                                                            d="M49.265 40.18c.53-.033.986.371 1.018.902.03.492-.316.92-.79 1.005l-.112.013-35.08 2.115c-.53.032-.987-.373-1.019-.903-.03-.493.317-.92.791-1.005l.112-.013 35.08-2.115zM34.763 47.067c.53-.026.982.383 1.009.914.024.492-.327.917-.802.997l-.112.012L14.588 50c-.531.027-.983-.382-1.01-.912-.024-.493.327-.918.802-.997l.112-.012 20.27-1.012z"
                                                            transform="translate(9 14)"></path>
                                                        <path fill="#031D44" fill-rule="nonzero"
                                                            d="M79.32.647c12.884 0 23.331 10.32 23.331 23.056s-10.447 23.056-23.33 23.056-23.33-10.32-23.33-23.056S66.437.647 79.32.647zm0 1.673c-11.963 0-21.656 9.576-21.656 21.383 0 11.807 9.693 21.383 21.656 21.383 11.964 0 21.658-9.576 21.658-21.383 0-11.807-9.694-21.383-21.658-21.383zm11.57 11.686c.972-.692 2.121.59 1.327 1.48L76.688 32.88c-.95.94-2.489.94-3.44 0l-.07-.076-6.78-8.252c-.64-.78.146-1.91 1.1-1.58l7.287 2.519zm-6.124 6.823l-9.239 6.59c-.263.188-.601.237-.907.131l-4.428-1.53 4.48 5.453.05.04c.147.097.34.1.462.03l.055-.04 9.527-10.674z"
                                                            transform="translate(9 14)"></path>
                                                        <path fill="#2E4554" fill-rule="nonzero"
                                                            d="M79.32.484c-12.972 0-23.493 10.393-23.493 23.219s10.521 23.22 23.493 23.22c12.973 0 23.494-10.394 23.494-23.22 0-12.827-10.52-23.22-23.494-23.22zm0 2c11.874 0 21.494 9.503 21.494 21.219 0 11.716-9.62 21.22-21.494 21.22-11.873 0-21.493-9.504-21.493-21.22s9.62-21.22 21.493-21.22z"
                                                            transform="translate(9 14)"></path>
                                                    </g>
                                                </g>
                                            </svg>
                                    ...
                                    <div>
                                        <div>
                                            <h3 class="landing_sentence1">
                                                Choose your ad type</h3>
                                        </div>
                                        <div style="padding-top:10px;"><span class="landing_sentence2"> We
                                                have three different ad types to suit all your needs.</span>
                                        </div>
                                    </div>
                                </div>
                                <div style="width:310px;padding-left:90px;text-align:center;">
                                    ...
                                    <div>
                                        <div>
                                            <div>
                                                <h3 class="landing_sentence1">
                                                    Manage your candidates</h3>
                                            </div>
                                            <div style="padding-top:10px;"><span class="landing_sentence2">We
                                                    make it easy for you to identify the best candidates
                                                    applying for your role.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    if ($totalJobs > 0) {
        ...
        <div>
            <div
                style="width: 1136px;margin: auto;padding: 24px 0px;height: 100%;display:flex;justify-content:space-between">
                <h2 class="landing_sentence3" style="text-align:center;">My recent job ads</h2>
                <?php
                // If the total number of jobs is more than 2, hide the landing banner
                if ($totalJobs > 3) {
                    ?>
            ...
            <div style="width: 1136px;margin: auto;height: 100%;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:156px;">
                                <div class="th_title">Job Actions</div>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '</div>
                                ...
                                <td>';
                            echo '<div class="td_title">';
                            switch ($jobStatus) {
                                case 'Draft':
                                    echo '-';
                                    break;
                                default:
                                    echo '<a class="applicantCount" href="job-listing.php?jobPostID=' . htmlspecialchars($row['Job_Post_ID']) . '#applicants" data-jobpostid="' . htmlspecialchars($row['Job_Post_ID']) . '">' . getApplicantCount($row['Job_Post_ID']) . '</a>';
                                    break;
                            }
                            echo '</div>
                               </td>
