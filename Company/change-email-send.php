    ...
    <div>
        <div class="register_form">
            <div style="padding:48px;">
                <div>
                    <h1 class="register_title">Change email address
                    </h1>
                </div>
                <?php
                if ($emailSent) {
                    ...
                    echo '<div style="padding-top:10px;"><span class="question"
                                    ...
                                    your new email address below and we will send you a link to verify your new email address.
                                </span></div>
...
<script>
    ...
    var companyEmail = "<?php echo $row['CompanyEmail']; ?>";
    ...
    emailInput.addEventListener('input', function () {
        ...
        if (this.value.trim() === '') {
            ...
            emailMessage.textContent = 'This is your current email';
            this.dataset.valid = '0';
            validationEmail.classList.remove('hide'); // Show the validation message
        } else {
