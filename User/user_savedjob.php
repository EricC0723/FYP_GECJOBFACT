       ...
       ?>
        ...
        <div class="col-lg-10 mb-4" id="savejob-section">
              ...
              <div class="block__87154 bg-white">
                ...
                <p>Added at <?php echo date('d-m-Y', strtotime($row['DateAdded']));?></p>
                ...
                foreach ($DescriptionArray as $description) {
                    if (!empty(trim($description))) {
                      echo '<p style="font-size:16px;color:grey;">' . trim($description) . '</p>';
                    }
                }
                if($job_row['job_status'] != 'Active')
                { ?>
                  <p>Expired</p>
                  <?php
                }
        ...
        ?>
        <div class="row mb-5 justify-content-center" id="empty-section">
            ...
            $.ajax({
              ...
              success:function(response){
                    ...
                    swal("Success", "Delete successfully", "success").then(function () {
                      location.replace("user_savedjob.php");
                    });
                },
            });
        }
